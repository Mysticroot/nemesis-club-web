...
export default function SponsorsSection() {
  return (
    <section className="relative py-20 bg-[#0E0E0E] text-white overflow-hidden border-t border-gray-800">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12 gap-6">
          ...
          <Link
            to="/become-sponsor"
            className="w-full md:w-auto inline-flex items-center justify-center gap-3 px-6 py-3 rounded-full text-lg font-bold uppercase tracking-wide 
                       bg-gradient-to-r from-[#D72638] to-[#FF5C00] 
                       text-white shadow-lg shadow-[#D72638]/40 
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div className="absolute left-0 top-0 w-20 h-full bg-gradient-to-r from-[#0E0E0E] to-transparent z-10" />
          <div className="absolute right-0 top-0 w-20 h-full bg-gradient-to-l from-[#0E0E0E] to-transparent z-10" />
        ...
        {/* Tagline */}
        <p className="mt-10 text-center text-gray-400 text-xl tracking-normal font-medium">
